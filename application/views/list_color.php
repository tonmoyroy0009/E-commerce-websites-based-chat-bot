                    ...
                    <div class="block">
                        <div class="block-header">
                            ...
                            <span class="col-lg-6" style="text-align: right;">
                              <a class="btn btn-default btn-rounded btn-condensed btn-sm" data-toggle="tooltip" title="Add Color" href="<?=base_url();?>color/add_color"><span title="Add Color"class="fa fa-plus"></span></a>
                            </span>
                        </div>
                        <div class="block-content">
                            <table class="table table-bordered table-striped js-dataTable-full">
                                ...
                                <tbody>
                                    <?php $c=0; foreach ($color_list as $post) 
                                    { ?>
                                    <tr>
										<td><?=++$c?></td>
                                        ...
                                        <td><?php if($post->created_by == "1")
                                         ...
                                         <td>
                                            ...
                                            <a href="<?= base_url("color/delete_color/".$post->id)?>" data-href="" class="btn btn-danger btn-rounded btn-condensed btn-sm delete"  data-toggle="tooltip" title="Delete" ><span class="fa fa-times" title="delete"></span></a>
                                         </td>
