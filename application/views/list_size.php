                    ...
                    <div class="block">
                        ...
                        <div class="block-content">
                            <table class="table table-bordered table-striped js-dataTable-full">
                                ...
                                <tbody>
                                    <?php $c=0; foreach ($size_list as $post) 
                                    { ?>
                                    <tr>
										<td><?=++$c?></td>
                                        ...
                                        <td><?php if($post->created_by == "1")
                                         ...
                                         <td>
                                            ...
                                            <a href="<?= base_url("size/delete_size/".$post->id)?>" data-href="" class="btn btn-danger btn-rounded btn-condensed btn-sm delete"  data-toggle="tooltip" title="Delete" ><span class="fa fa-times" title="delete"></span></a>
                                         </td>
